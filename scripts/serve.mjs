...
const publicFiles = new Set(["index.html", "404.html", "styles.css", "portfolio.js", "phimask-carousel.js", "favicon.svg", "apple-touch-icon.png", "og-image.png", "robots.txt", "sitemap.xml"]);
const server = Bun.serve({
  ...
  async fetch(request) {
    ...
    const isAsset = /^assets\/(work|fonts)\/[^/]+\.(mp4|webp|png|woff2)$/.test(pathname);
